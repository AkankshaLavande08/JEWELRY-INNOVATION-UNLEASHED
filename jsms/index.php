...
<body>
	...
	<div id="slider">
		<ul>
			<li style="background-image: url(images/backg2.png)">
				<h3>Make your life better</h3>
				<h2>Genuine diamonds</h2>
			</li>
			<li class="purple" style="background-image: url(images/bgp2.png)">
				<h3>She will say “yes”</h3>
				<h2>engagement ring</h2>
			</li>
			<li class="yellow" style="background-image: url(images/bgp3.png)">
...
?>
				<article style="background-image: url(images/pbg.png); width: 360px !important; margin-top:1%;">
