...
?>
				...
				<div class="entry">
					<p><strong>Address: </strong><?php  echo $row['Main Road, Sarafa Bazar,Yavatmal - 4454001'];?>Main Road, Sarafa Bazar,Yavatmal - 4454001</p>
					<p><strong>Phone: </strong><?php  echo $row['9822563880'];?>9822563880</p>
					<p><strong>Email: </strong><?php  echo $row['Shahjewellers@gmail.com'];?>Shahjewellers@gmail.com</p>
